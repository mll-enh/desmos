...
function onEvent(name, value1, value2)
	...
	elseif name == 'Lyrics_BF' then
		if value1 == '' then
			...
			setTextFont('lyricInstance'..lyricNumber, textFont)
			doTweenColor('lyricInstance'..lyricNumber..'color', 'lyricInstance'..lyricNumber, 'ffffff', 0.3, 'QuadOut')
			doTweenY('lyricInstance'..lyricNumber, 'lyricInstance'..lyricNumber, 500+lyricOffsetY, 0.3, 'QuadOut')
			doTweenY('lyricInstance'..lyricNumber2, 'lyricInstance'..lyricNumber2, 460+lyricOffsetY, 0.3, 'QuadOut')
			setProperty('lyricInstance'..lyricNumber2 .. '.alpha', 0.5)
			setProperty('lyricInstance'..lyricNumber3 .. '.visible', false)
			setProperty('lyricInstance'..lyricNumber4 .. '.visible', false)
		end
		--icon
		if value2 == '' then
			...
			lyricIcon3 = lyricIcon -2
			lyricIcon4 = lyricIcon -3
			makeLuaSprite('iconInstance'..lyricIcon, 'lyrics/'..value2, screenWidth/2+50+iconOffsetX, 500+lyricOffsetY);
			setObjectCamera('iconInstance'..lyricIcon, 'camHUD')
			scaleObject ('iconInstance'..lyricIcon, 0.8, 0.8)
			setProperty('iconInstance'..lyricIcon..'.flipX', true)
			addLuaSprite('iconInstance'..lyricIcon, true);
			doTweenY('iconInstance'..lyricIcon, 'iconInstance'..lyricIcon, 450+lyricOffsetY, 0.3, 'QuadOut')
			doTweenY('iconInstance'..lyricIcon2, 'iconInstance'..lyricIcon2, 410+lyricOffsetY, 0.3, 'QuadOut')
			setProperty('iconInstance'..lyricIcon2 .. '.alpha', 0.5)
			setProperty('iconInstance'..lyricIcon3 .. '.visible', false)
			setProperty('iconInstance'..lyricIcon4 .. '.visible', false)
		end
	end
end
