...
function onUpdate()
	...
	doTweenY('Cinematics1', 'UpperBar', -30, Speed, 'Linear')
	doTweenY('Cinematics2', 'LowerBar', 630, Speed, 'Linear')
	noteTweenY('NOTEMOVE1', 0, 100, Speed, 'Linear')	
	noteTweenY('NOTEMOVE2', 1, 100, Speed, 'Linear')
	noteTweenY('NOTEMOVE3', 2, 100, Speed, 'Linear')
	noteTweenY('NOTEMOVE4', 3, 100, Speed, 'Linear')
	noteTweenY('NOTEMOVE5', 4, 100, Speed, 'Linear')
	noteTweenY('NOTEMOVE6', 5, 100, Speed, 'Linear')
	noteTweenY('NOTEMOVE7', 6, 100, Speed, 'Linear')
	noteTweenY('NOTEMOVE8', 7, 100, Speed, 'Linear')
	...
	doTweenY('Cinematics1', 'UpperBar', -30, Speed, 'Linear')
	doTweenY('Cinematics2', 'LowerBar', 630, Speed, 'Linear')
	noteTweenY('NOTEMOVE1', 0, 500, Speed, 'Linear')	
	noteTweenY('NOTEMOVE2', 1, 500, Speed, 'Linear')
	noteTweenY('NOTEMOVE3', 2, 500, Speed, 'Linear')
	noteTweenY('NOTEMOVE4', 3, 500, Speed, 'Linear')
	noteTweenY('NOTEMOVE5', 4, 500, Speed, 'Linear')
	noteTweenY('NOTEMOVE6', 5, 500, Speed, 'Linear')
	noteTweenY('NOTEMOVE7', 6, 500, Speed, 'Linear')
	noteTweenY('NOTEMOVE8', 7, 500, Speed, 'Linear')
	doTweenAlpha('AlphaTween1', 'healthBarBG', 0, 0.1)
	doTweenAlpha('AlphaTween2', 'healthBar', 0, 0.1)
	doTweenAlpha('AlphaTween3', 'scoreTxt', 0, 0.1)
	doTweenAlpha('AlphaTween4', 'iconP1', 0, 0.1)
