...
xx = 390; -- Code to change the position of the camera to the left or right for your opponent, Less = Left (They can be negative numbers), More = Right
yy = 525; -- Code to change the position of the camera up or down for the enemy Less = Down (They can be negative numbers), More = Up
xx2 = 850; -- Same code as above, but for boyfriend left, right
yy2 = 525; -- Same code as above, but for boyfriend up, down
...
followchars = false; -- This code is necessary for the script to work, don't even think about deleting it!
del = 0;
del2 = 0;
...
function onUpdate() -- The Main Code
    ...
    if curStep >= 1152 and curStep <= 1407 then
        xx = 300
        yy = 600
        xx2 = 955
        yy2 = 600
